    ...
    internal sealed class TerrainBuilder
    {
        ...
        private void CreateBackdrop(Transform parent)
        {
            shapes.CreatePatch(
                ...
                Vector2.zero,
                new Vector2(28f, 16f),
                new Color(0.07f, 0.15f, 0.17f),
                -5000,
                parent,
                sortingLayerName: SortingLayerNames.Ground);
            shapes.CreatePatch(
                "夕暮れの霞",
                new Vector2(0f, 4.2f),
                new Vector2(26f, 3.1f),
                new Color(0.37f, 0.31f, 0.36f, 0.45f),
                -4990,
                parent,
                sortingLayerName: SortingLayerNames.Ground);
            shapes.CreateEllipse(
                "沈む光",
                new Vector2(5.8f, 4.35f),
                new Vector2(5.6f, 5.6f),
                new Color(0.92f, 0.55f, 0.35f, 0.10f),
                -4980,
                parent,
            ...
            shapes.CreateEllipse(
                ...
                new Color(1f, 0.72f, 0.43f, 0.13f),
                -4979,
                parent,
                SortingLayerNames.Ground);
            ...
            for (int i = 0; i < 9; i++)
            {
                ...
                shapes.CreatePatch(
                    "遠景の幹",
                    new Vector2(x, 3.2f),
                    new Vector2(0.34f, height),
                    new Color(0.08f, 0.19f, 0.18f),
                    -4960,
                    parent,
                    sortingLayerName: SortingLayerNames.Ground);
                shapes.CreateEllipse(
                    "遠景の樹冠",
                    new Vector2(x, 4.05f),
                    new Vector2(2.4f, 1.55f),
                    new Color(0.09f, 0.24f, 0.21f),
                    -4959,
                    parent,
                    SortingLayerNames.Ground);
            }
            ...
            for (int x = -playableRadius + 2; x <= playableRadius - 2; x++)
            {
                ...
                if (x % 3 == 0)
                {
                    ...
                    shapes.CreateEllipse(
                        ...
                        new Color(0.48f, 0.34f, 0.23f),
                        PrototypeWorldMath.GroundOrder + 92,
                        parent);
                }
            }
        }
        ...
        private void CreateGroundEdge(Transform parent)
        {
            shapes.CreatePatch(
                ...
                new Vector2(15.7f, 7.95f),
                new Color(0.035f, 0.08f, 0.10f, 0.72f),
                PrototypeWorldMath.GroundOrder - 30,
                parent,
                sortingLayerName: SortingLayerNames.Ground);
            shapes.CreatePatch(
                "地面の厚み",
                new Vector2(0f, -0.16f),
                new Vector2(15.35f, 7.78f),
                new Color(0.25f, 0.27f, 0.18f),
                PrototypeWorldMath.GroundOrder - 20,
                parent,
                sortingLayerName: SortingLayerNames.Ground);
            shapes.CreatePatch(
                "手前の土の断面",
                new Vector2(0f, -3.88f),
                new Vector2(15.2f, 0.27f),
                new Color(0.29f, 0.20f, 0.15f),
                PrototypeWorldMath.GroundOrder + 1,
                parent,
                sortingLayerName: SortingLayerNames.Ground);
            shapes.CreatePatch(
                "断面の明るい縁",
                new Vector2(0f, -3.73f),
                new Vector2(15.2f, 0.06f),
                new Color(0.56f, 0.43f, 0.25f),
                PrototypeWorldMath.GroundOrder + 2,
                parent,
                sortingLayerName: SortingLayerNames.Ground);
        }
        ...
        private void CreateForegroundFrame(Transform parent)
        {
            shapes.CreateEllipse(
                "左手前の葉影",
                new Vector2(-7.45f, -4.18f),
                new Vector2(4.1f, 2.65f),
                new Color(0.05f, 0.17f, 0.15f, 0.94f),
                3000,
                parent,
                SortingLayerNames.Foreground);
            shapes.CreateEllipse(
                "左手前の葉",
                new Vector2(-6.72f, -3.88f),
                new Vector2(2.55f, 1.55f),
                new Color(0.10f, 0.31f, 0.22f),
                3001,
                parent,
                SortingLayerNames.Foreground);
            shapes.CreateEllipse(
            ...
            shapes.CreateEllipse(
                "右手前の葉",
                new Vector2(6.75f, -3.86f),
                new Vector2(2.45f, 1.48f),
                new Color(0.12f, 0.35f, 0.23f),
                3001,
                parent,
                SortingLayerNames.Foreground);
        }
