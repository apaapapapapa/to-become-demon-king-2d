...
- Status: System Implemented / No Content Registered
...
ArtのDefinition、進捗、習得、熟練度、Ability付与、Save基盤は実装済みですが、正式なArtデータは未登録です。ページ追加時は [Artテンプレート](../../templates/art.md) と [Art仕様](../../specifications/art.md) を参照してください。
