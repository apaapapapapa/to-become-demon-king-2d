...
ArtからのAbility付与、近接ダメージの効果成立通知、SkillとEvolutionからのクールダウン補正は実装済みです。Abilityコスト補正、非同期Abilityの終了通知元、回復・バフ・デバフExecutorからの効果成立通知は今後実装します。詳細は [Art仕様](./art.md)、[Skill仕様](./skill.md)、[Evolution仕様](./evolution.md) を参照してください。
