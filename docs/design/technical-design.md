...
詳細は [Ability仕様](../specifications/ability.md)、[Art仕様](../specifications/art.md)、[Skill仕様](../specifications/skill.md)、[戦闘仕様](../specifications/combat.md)、[成長仕様](../specifications/progression.md) を参照してください。
...
- Domain: ExperienceTable、CharacterProgressionState、ArtMasteryTable、ArtProgressState、Skill取得状態、Reward関連、Save Mapper等
